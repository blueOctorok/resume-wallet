...
RESEND_API_KEY=                    # Legacy — still used by other send helpers + Supabase Auth SMTP until cutover finishes
RESEND_FROM_EMAIL=                 # e.g. ZKnight <zknight@verify.zknight.io>
