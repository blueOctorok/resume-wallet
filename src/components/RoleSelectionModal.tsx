...
const EMPLOYER_AUTH_TIERS = [
  {
    id: 'company_owner',
    label: 'Company Owner',
    description: 'I\'m authorized to set up and manage this company on Provven.',
  },
  {
    id: 'team_member',
    label: 'Team Member',
    description: 'My company is already on Provven — I\'m joining the team.',
  },
] as const
                  ...
                  {showRequestForm && !pendingRequest && !requestSubmitted && (
                    <div className={`p-4 rounded-xl ${isDark ? 'bg-gray-800/50 border border-gray-700' : 'bg-gray-50 border border-gray-200'}`}>
                      <h4 className={`font-semibold mb-1 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                        Set up your company on Provven
                      </h4>
                      ...
                      <p className={`text-xs mt-3 ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                        <strong>Team members:</strong> If your company is already on Provven, use your company email and you&apos;ll be added automatically.
                      </p>
                    </div>
                  )}
