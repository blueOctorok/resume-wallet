    ...
    >
        ...
        <div className='flex items-center gap-2'>
          <div
            className={`w-8 h-8 rounded-lg flex items-center justify-center ${
              isDarkTheme(theme) ? 'bg-indigo-500/20' : 'bg-indigo-50'
            }`}
          >
            <Wallet
              className={`w-4 h-4 ${
          ...
          <span
            className={`text-sm font-semibold ${
              !isDarkTheme(theme) ? 'text-gray-800' : 'text-gray-200'
            }`}
          >
            Wallet
          </span>
        ...
        <div className='flex items-center gap-2'>
          <span
            className={`text-xs font-medium ${
              !isDarkTheme(theme) ? 'text-gray-600' : 'text-brand-cream/70'
            }`}
          >
            Address:
          </span>
        ...
        >
          <code
            className={`text-xs font-mono break-all ${
              !isDarkTheme(theme) ? 'text-gray-700' : 'text-gray-300'
            }`}
          >
      ...
      <div
        className={`mt-3 pt-3 border-t ${
          !isDarkTheme(theme) ? 'border-gray-200' : 'border-gray-600'
        }`}
      >
        <div className='flex items-center justify-between text-xs'>
          ...
          <span
            className={`font-medium ${
              !isDarkTheme(theme) ? 'text-gray-800' : 'text-indigo-400'
            }`}
          >
            Base Sepolia
          </span>
          ...
          <div className='flex items-center justify-between text-xs mt-1'>
            ...
            <span
              className={`font-medium capitalize ${
                !isDarkTheme(theme) ? 'text-gray-800' : 'text-gray-300'
              }`}
            >
