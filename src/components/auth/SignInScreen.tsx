...
const INK_INPUT =
  ...
  'focus:border-[#f15a2b]/55 focus:ring-[#f15a2b]/35 ' +
  'dark:bg-white/[0.04] dark:border-white/12 dark:text-[#f4f1ea] dark:placeholder:text-slate-500 ' +
  'dark:focus:border-[#f15a2b]/55 dark:focus:ring-[#f15a2b]/35'
      ...
      <div className='relative z-10 mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-4 py-12'>
        ...
        <div
          className={cn(
            ...
            'ring-1 ring-[#f15a2b]/15',
          )}
        >
          <div
            aria-hidden
            className='pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#f15a2b]/40 to-transparent'
          />
            ...
            <>
              ...
              <Button
                ...
                className={cn(
                  ...
                  'hover:border-[#f15a2b]/40 hover:bg-white/[0.08]',
                  'dark:border-white/15 dark:bg-white/[0.04] dark:text-[#f4f1ea]',
                  'dark:hover:border-[#f15a2b]/40 dark:hover:bg-white/[0.08]',
                )}
