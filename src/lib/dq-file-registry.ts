...
export const DQ_ITEM_DEFINITIONS: DqItemDefinition[] = [
  {
    ...
    description: 'State DMV pull via integrated CRA (Key / Accio).',
    source: 'company_order',
    cfrNote: '§391.23',
    blocksOverallCompletion: true,
    employerEmptyHint: 'Order an MVR for this driver.',
    driverEmptyHint: 'Your employer may request or order an MVR.',
  },
  {
    id: 'psp',
    label: 'FMCSA PSP',
    description: 'Crash and inspection history via FMCSA PSP.',
    source: 'company_order',
    cfrNote: '§391.23',
    blocksOverallCompletion: true,
    employerEmptyHint: 'Order a PSP for this driver.',
    driverEmptyHint: 'Your employer may request or order a PSP.',
  },
  {
    id: 'dot_application',
