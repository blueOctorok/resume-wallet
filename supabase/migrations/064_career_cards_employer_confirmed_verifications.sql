-- verified_jobs_count: count employment rows where a past employer responded on-file
-- (full confirmation or partial / corrected dates). Drives talent search + career card trust UI.
...
COMMENT ON FUNCTION search_talent IS 'Search for candidates — uses career_cards view (064: verified_jobs_count includes PARTIALLY_VERIFIED).';
