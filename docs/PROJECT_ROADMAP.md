...
| **Pingram SMS Outreach Text** | **✅ Done (code)** | **Invite SMS via Pingram (`send-sms` + `candidate_phone` / `sms_sent_at`). Text beside Email on Outreach. Migration `103` — apply in SQL editor. Ops: Provven A2P 10DLC on paid Pingram plan.** |
